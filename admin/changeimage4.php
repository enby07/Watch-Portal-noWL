...
move_uploaded_file($_FILES["img4"]["tmp_name"],"img/watchimages/".$_FILES["img4"]["name"]);
$sql="update watches set Vimage4=:vimage where id=:id";
...
<head>
	...
	<title>Watch Portal | Admin Update Image 4</title>
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage4 from watches where watches.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
